...
execute positioned ~ ~-1 ~ as @e[distance=..1.4,type=!#true_ending:misc] run damage @s 54 true_ending:mob_attack_pierce_shield by @e[type=ender_dragon,limit=1,sort=nearest]
